...
class VirtualDisplayManager(
    ...
    fun create(
        ...
        try {
            ...
            // MUST include PUBLIC for the screenshot backend to have permission to capture it.
            ...
            if (backend is ai.opencyvis.backend.RemoteBackend) {
                ...
                val flagSetsToTry = listOf(
                    ...
                    // Minimal: PUBLIC + SUPPORTS_TOUCH + ROTATES_WITH_CONTENT

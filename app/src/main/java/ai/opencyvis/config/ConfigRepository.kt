...
class ConfigRepository(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_USE_PHYSICAL_DISPLAY = "use_physical_display"
    ...
    var usePhysicalDisplay: Boolean
        get() = prefs.getBoolean(KEY_USE_PHYSICAL_DISPLAY, false)
        set(value) = prefs.edit().putBoolean(KEY_USE_PHYSICAL_DISPLAY, value).apply()
}

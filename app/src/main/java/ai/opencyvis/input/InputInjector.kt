...
class InputInjector(
    ...
    suspend fun typeText(text: String): Boolean {
        ...
        // Force a tap to ensure focus before typing, especially for Virtual Displays
        // where window focus might be lost.
        // We don't have the target coordinates here, so we assume the AI already clicked.
        // However, adding a small delay can help the system settle.
        delay(100)
